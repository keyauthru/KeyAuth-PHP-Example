...
<head>
        ...
        <link rel="shortcut icon" href="https://keyauth.ru/favicon.png" type="image/x-icon">
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/notyf@3/notyf.min.css">
        <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700" />

        <link href="https://keyauth.ru/v2/plugins.bundle.css" rel="stylesheet"
                type="text/css">
        <link href="https://keyauth.ru/v2/style.bundle.css" rel="stylesheet" type="text/css">
</head>
